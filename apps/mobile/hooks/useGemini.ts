    ...
    try {
      ...
      const response = await newGenAI.models.generateContent({
        ...
        contents: [
          {
            role: 'model',
            parts: [{ text: "You are a helpful culinary assistant that finds recipes based on available ingredients. Don't ask questions. Only answer with recipes you got from web search." }]
          },
          {
            role: 'user',
